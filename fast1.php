...
if(isset($token2)){
	...
	if($exe == "41158896424" || $exe == "149859461799466"){
		...
		$ch = curl_init('http://localhost/easyliker/token_check.php');
		...
		header('Location:fast.php?i=Please Allow App to Access Your Profile! !, Try Again..');}
	}else{
	header('Location:fast.php?i=Please Generate token Using HTC Else NO Likessss !!!! !');}
	}else{
	header('Location:fast.php?i=Please Allow App to Access Your Profile! !, Try Again..');}
?>