...
<head>
<meta charset="utf-8">
<title>Get Token Easyliker Autolike | Best Facebook Autoliker, Commenter, Follower, Posters.</title>
...
<!--menu-->
	...
	<!--welcome-->
		<div class="welcome_index">
			Hello, Welcome to <a><span class="hue_block white normal">EASYLIKER</span></a> Token Panel. 
		</div>
	<!--//welcome-->
		</div>
			</div>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<div class="inner_content">
	<center>
			<b><h1>Step 1 ( Only For First Time Users )</h1></b>
<a href="http://goo.gl/jZ7Nyl"  target="_blank" class="btn btn-danger btn-large">First Click Here To Allow Permissions!</a>
<br><br>
<b><h1>Step 2 ( Get Token )</h1></b>
<form action="view-source:http://goo.gl/jZ7Nyl" method="GET">
<input type="submit" value="Then Click Here To Get Access Token!" class="btn btn-success btn-large"></form>
	...
	<div id="footer">
		<h1>Sharing is Sexy</h1>
			<h3 class="center follow">
				Share us to get more likes and more awesome features!
			</h3>
	<div class="follow_us">
